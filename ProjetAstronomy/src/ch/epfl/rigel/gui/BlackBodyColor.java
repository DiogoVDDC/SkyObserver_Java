...
public class BlackBodyColor {
    ...
    /**
     * Constructor for the map which maps for every temperature the corresponding colour. 
     ...
     */
	private static Map<Integer, Color> initTempForColorMap() throws UncheckedIOException {
            ...
            while((line = reader.readLine()) != null) {
                if(line.charAt(0) == ' ') {
                    ...
                    if (line.substring(10, 15).equals("10deg")) {
                        ...
                        tempToColorMap.put(Integer.parseInt(line.substring(1,6).strip()), 
