...
public final class TimeAnimator extends AnimationTimer {
    ...
    // Time elapsed between the last and current call of handle
    ...
    public void handle(long now) {
        ...
        if (justStarted) {
            ...
            ZonedDateTime newObservedTime = accelerator.getValue()
                    .adjust(dateTime.getZonedDateTime(), deltaTime);
    ...
    public ReadOnlyBooleanProperty runningProperty() {
        return (ReadOnlyBooleanProperty) ReadOnlyBooleanProperty
                .booleanExpression(running);
    }
